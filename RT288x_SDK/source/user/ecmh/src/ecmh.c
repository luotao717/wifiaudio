...
***************************************
 $Author: yy $
 $Id: ecmh.c,v 1.7 2011-05-23 07:38:48 yy Exp $
 $Date: 2011-05-23 07:38:48 $
***************************************
...
/* Ralink */
			...
			if(g_conf->es && !strcmp(IGNORE_INTERFACE1, 
#ifndef ECMH_GETIFADDR
                                        devname
#else
                                        ifa->ifa_name
			...
			if(g_conf->es && !strcmp(IGNORE_INTERFACE2,
#ifndef ECMH_GETIFADDR
                                        devname
#else
                                        ifa->ifa_name
...
int main(int argc, char *argv[])
{
	...
	/* Handle arguments */
	while ((i = getopt_long(argc, argv, "fi:pPu:e"
#ifdef ECMH_BPF
		"tT"
#endif
		"vV"
